...
function Footer() {
  return (
    <footer className='border-dashed border-[#B5E853]  border-t-[1px] py-20 px-3'>
        <h1 className='text-[#B5E853] max-w-[99 %] lg:max-w-[70%] mx-auto  text-3xl mb-2 font-bold'>./ <span>Contact</span></h1>
        <div className='lg:max-w-[67%] max-w-[93%] mx-auto flex flex-col items-start justify-between'>
